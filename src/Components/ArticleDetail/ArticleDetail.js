...
export default function ArticleDetail(props) {
     ...
     author açıklama */
        ...
        axios
          ...
          .then(function (response) {
            // handle success
            setimgUrl({
              imgurl: response.data.media_details.sizes.full.source_url,
            });
          });
  ...
  // use effect içerisinde update oldukları için tekrar render ediyor. unlimited..
  ...
  return (
    <section className="articleDetail">
      ...
      <Helmet>
        ...
        {imgUrl.imgurl && (
          <link rel="preload" href={imgUrl.imgurl} as="image" />
        )}
      </Helmet>
      <h1 className="placeholder-glow">
        <section className={!isLoading ? "d-none" : false}>
