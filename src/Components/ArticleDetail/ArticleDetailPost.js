...
export default function ArticleDetailPost() {
  return (
    <a  href="/#" className='articleDetailPost'>
        <img width={293} height={195} src="https://images.unsplash.com/photo-1518791841217-8f162f1e1131?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60"
        className='img-fluid'
        alt="" />
